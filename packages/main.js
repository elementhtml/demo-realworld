...
export default {
    ...
    variables: {
        ...
        toggleFeedToYour: '{"`main|#article-feed-pointer`@resource": "api://api/articles/feed?' + (new URLSearchParams({ ...filters, limit, offset })).toString() + '", "`ul|li a.active`@class": "nav-link", "`li|a`@class": "nav-link active" }',
        toggleFeedToGlobal: '{"`main|#article-feed-pointer`@resource": "api://api/articles?' + (new URLSearchParams({ ...filters, limit, offset })).toString() + '", "`ul|li a.active`@class": "nav-link", "`li|a`@class": "nav-link active" }',
